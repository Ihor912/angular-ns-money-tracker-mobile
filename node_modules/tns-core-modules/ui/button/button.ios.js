...
var Button = (function (_super) {
    ...
    function Button() {
        ...
        _this.nativeView = UIButton.buttonWithType(1);
        _this._tapHandler = TapHandlerImpl.initWithOwner(new WeakRef(_this));
        _this.nativeView.addTargetActionForControlEvents(_this._tapHandler, "tap", 64);
        return _this;
    }
    ...
    Button.prototype._updateHandler = function (subscribe) {
        ...
        if (subscribe) {
            if (!this._stateChangedHandler) {
                this._stateChangedHandler = new control_state_change_1.ControlStateChangeListener(this.nativeView, function (s) {
    ...
    Button.prototype[button_common_1.borderTopWidthProperty.setNative] = function (value) {
        var inset = this.nativeView.contentEdgeInsets;
    ...
    Button.prototype[button_common_1.whiteSpaceProperty.setNative] = function (value) {
        var nativeView = this.nativeView.titleLabel;
        switch (value) {
            case "normal":
